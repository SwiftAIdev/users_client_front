...
export const PermissionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deletePermissionPermissionsPermissionIdDelete(permissionId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PermissionSchema>> {
...
export const PermissionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deletePermissionPermissionsPermissionIdDelete(permissionId: number, options?: RawAxiosRequestConfig): AxiosPromise<PermissionSchema> {
...
export const RolesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getRolesRolesGet: async (page?: number, size?: number, isDelete?: boolean | null, isDeleteIn?: string | null, name?: string | null, id?: number | null, idIn?: string | null, idNeq?: string | null, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/roles/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const RolesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRolesRolesGet(page?: number, size?: number, isDelete?: boolean | null, isDeleteIn?: string | null, name?: string | null, id?: number | null, idIn?: string | null, idNeq?: string | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginationRequestRoleSchema>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getRolesRolesGet(page, size, isDelete, isDeleteIn, name, id, idIn, idNeq, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const RolesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getRolesRolesGet(page?: number, size?: number, isDelete?: boolean | null, isDeleteIn?: string | null, name?: string | null, id?: number | null, idIn?: string | null, idNeq?: string | null, options?: RawAxiosRequestConfig): AxiosPromise<PaginationRequestRoleSchema> {
            return localVarFp.getRolesRolesGet(page, size, isDelete, isDeleteIn, name, id, idIn, idNeq, options).then((request) => request(axios, basePath));
        },
        /**
         * Remove a permission to a role by ID.  This endpoint allows adding a permission to an existing role.
         * @summary Remove Permission To Role
...
export class RolesApi extends BaseAPI {
     ...
     * @memberof RolesApi
     */
    public getRolesRolesGet(page?: number, size?: number, isDelete?: boolean | null, isDeleteIn?: string | null, name?: string | null, id?: number | null, idIn?: string | null, idNeq?: string | null, options?: RawAxiosRequestConfig) {
        return RolesApiFp(this.configuration).getRolesRolesGet(page, size, isDelete, isDeleteIn, name, id, idIn, idNeq, options).then((request) => request(this.axios, this.basePath));
    }
